                    ...
                    <div className="relative z-10 w-full h-full overflow-y-auto no-scrollbar pb-8">
                        ...
                        <div className="px-6 mt-8 space-y-8">
                            ...
                            <div className="space-y-3">
                                <a href={`tel:${cardData.phone}`} className="flex items-center gap-4 p-4 rounded-2xl glass-panel group hover:bg-slate-50 transition-colors w-full overflow-hidden">
                                    ...
                                    <span className="text-slate-700 font-medium break-all overflow-hidden">{cardData.phone}</span>
                                </a>

                                <a href={`mailto:${cardData.email}`} className="flex items-center gap-4 p-4 rounded-2xl glass-panel group hover:bg-slate-50 transition-colors w-full overflow-hidden">
                                    <div className="w-10 h-10 rounded-full bg-slate-200 flex items-center justify-center text-slate-700 shrink-0">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                    </div>
                                    <span className="text-slate-700 font-medium break-all overflow-hidden">{cardData.email}</span>
                                </a>
